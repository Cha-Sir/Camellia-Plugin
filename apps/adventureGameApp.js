...
export class AdventureGame extends plugin {
    constructor() {
        super({
            ...
            rule: [
                ...
                { // Alias for #查看佣兵 without argument
                    reg: '^#查看$',
                    fnc: 'viewMercenaryDetail',
                    permission: 'all',
    ...
    async reloadDataAdmin(e) {
        ...
        try {
            ...
            gameHandler.initializeGameHandlerTimedTasks(this); // Re-initialize with new data potentially
    ...
    /**
     * 获取玩家数据，封装了 dataManager.getPlayerData
     * @param {string} userId 用户QQ号
     * @param {string} [nickname=''] 用户昵称，可选
     * @returns {Promise<{playerData: object, isNewPlayer: boolean}>}
     */
    ...
    async handleConfirmHealCommand(e) { return await hospitalHandler.handleConfirmHealCommand(e, this); }
    ...
    async evolveMercenary(e) { return await mercenaryHandler.handleEvolveMercenary(e, this); } // 新增
